...
ActiveRecord::Schema.define(version: 20180412075413) do
  ...
  create_table "regular_shifts", force: :cascade, comment: "通常時のシフト" do |t|
    ...
    t.integer "start_at", default: 0, null: false, comment: "開始時刻（time_block.yml参照）"
    t.integer "end_at", default: 0, null: false, comment: "開始時刻（time_block.yml参照）"
  end
